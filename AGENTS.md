...
3. Keep all Pi imports (`@earendil-works/pi-ai`, `@earendil-works/pi-agent-core`, `@earendil-works/pi-coding-agent` — approved by ADR 0001, see `docs/adr/0001-reuse-pi-extension-mechanism.md`) inside `src/main/agent` and `src/main/model` (formerly `src/main/llm`, re-homed by domain in #59).
